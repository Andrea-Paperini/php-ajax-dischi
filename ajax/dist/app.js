...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    'success': function success(data) {
      console.log(JSON.parse(data)); // l'API restituisce un array di oggetti perciò uso la dot notation per recuperare i dati effettivi
      // specifico l'array:
...
__webpack_require__(/*! C:\Users\Andre\Documents\Classe\php-ajax-dischi\ajax\src\app.js */"./src/app.js");
module.exports = __webpack_require__(/*! C:\Users\Andre\Documents\Classe\php-ajax-dischi\ajax\src\app.scss */"./src/app.scss");
